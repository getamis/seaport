...
var OrderFulfillerMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// OrderFulfillerNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the OrderFulfiller contract.
type OrderFulfillerNonceIncrementedIterator struct {
	Event *OrderFulfillerNonceIncremented // Event containing the contract specifics and raw log
...
func (it *OrderFulfillerNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(OrderFulfillerNonceIncremented)
...
func (it *OrderFulfillerNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *OrderFulfillerNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// OrderFulfillerNonceIncremented represents a NonceIncremented event raised by the OrderFulfiller contract.
type OrderFulfillerNonceIncremented struct {
	NewNonce *big.Int
...
func (_OrderFulfiller *OrderFulfillerFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*OrderFulfillerNonceIncrementedIterator, error) {
	...
	logs, sub, err := _OrderFulfiller.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &OrderFulfillerNonceIncrementedIterator{contract: _OrderFulfiller.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_OrderFulfiller *OrderFulfillerFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *OrderFulfillerNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _OrderFulfiller.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(OrderFulfillerNonceIncremented)
				if err := _OrderFulfiller.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_OrderFulfiller *OrderFulfillerFilterer) ParseNonceIncremented(log types.Log) (*OrderFulfillerNonceIncremented, error) {
	event := new(OrderFulfillerNonceIncremented)
	if err := _OrderFulfiller.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
