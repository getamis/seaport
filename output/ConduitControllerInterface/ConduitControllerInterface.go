...
func (_ConduitControllerInterface *ConduitControllerInterfaceFilterer) FilterPotentialOwnerUpdated(opts *bind.FilterOpts, conduit []common.Address, newPotentialOwner []common.Address) (*ConduitControllerInterfacePotentialOwnerUpdatedIterator, error) {
	...
	logs, sub, err := _ConduitControllerInterface.contract.FilterLogs(opts, "PotentialOwnerUpdated", conduitRule, newPotentialOwnerRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event PotentialOwnerUpdated(address indexed conduit, address indexed newPotentialOwner)
func (_ConduitControllerInterface *ConduitControllerInterfaceFilterer) WatchPotentialOwnerUpdated(opts *bind.WatchOpts, sink chan<- *ConduitControllerInterfacePotentialOwnerUpdated, conduit []common.Address, newPotentialOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ConduitControllerInterface.contract.WatchLogs(opts, "PotentialOwnerUpdated", conduitRule, newPotentialOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
