...
var ConsiderationBaseMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// ConsiderationBaseNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the ConsiderationBase contract.
type ConsiderationBaseNonceIncrementedIterator struct {
	Event *ConsiderationBaseNonceIncremented // Event containing the contract specifics and raw log
...
func (it *ConsiderationBaseNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ConsiderationBaseNonceIncremented)
...
func (it *ConsiderationBaseNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ConsiderationBaseNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ConsiderationBaseNonceIncremented represents a NonceIncremented event raised by the ConsiderationBase contract.
type ConsiderationBaseNonceIncremented struct {
	NewNonce *big.Int
...
func (_ConsiderationBase *ConsiderationBaseFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*ConsiderationBaseNonceIncrementedIterator, error) {
	...
	logs, sub, err := _ConsiderationBase.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &ConsiderationBaseNonceIncrementedIterator{contract: _ConsiderationBase.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_ConsiderationBase *ConsiderationBaseFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *ConsiderationBaseNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ConsiderationBase.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ConsiderationBaseNonceIncremented)
				if err := _ConsiderationBase.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_ConsiderationBase *ConsiderationBaseFilterer) ParseNonceIncremented(log types.Log) (*ConsiderationBaseNonceIncremented, error) {
	event := new(ConsiderationBaseNonceIncremented)
	if err := _ConsiderationBase.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
