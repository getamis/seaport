...
var GettersAndDeriversMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// GettersAndDeriversNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the GettersAndDerivers contract.
type GettersAndDeriversNonceIncrementedIterator struct {
	Event *GettersAndDeriversNonceIncremented // Event containing the contract specifics and raw log
...
func (it *GettersAndDeriversNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(GettersAndDeriversNonceIncremented)
...
func (it *GettersAndDeriversNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *GettersAndDeriversNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// GettersAndDeriversNonceIncremented represents a NonceIncremented event raised by the GettersAndDerivers contract.
type GettersAndDeriversNonceIncremented struct {
	NewNonce *big.Int
...
func (_GettersAndDerivers *GettersAndDeriversFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*GettersAndDeriversNonceIncrementedIterator, error) {
	...
	logs, sub, err := _GettersAndDerivers.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &GettersAndDeriversNonceIncrementedIterator{contract: _GettersAndDerivers.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_GettersAndDerivers *GettersAndDeriversFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *GettersAndDeriversNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _GettersAndDerivers.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(GettersAndDeriversNonceIncremented)
				if err := _GettersAndDerivers.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_GettersAndDerivers *GettersAndDeriversFilterer) ParseNonceIncremented(log types.Log) (*GettersAndDeriversNonceIncremented, error) {
	event := new(GettersAndDeriversNonceIncremented)
	if err := _GettersAndDerivers.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
