...
var VerifiersMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// VerifiersCounterIncrementedIterator is returned from FilterCounterIncremented and is used to iterate over the raw logs and unpacked data for CounterIncremented events raised by the Verifiers contract.
type VerifiersCounterIncrementedIterator struct {
	Event *VerifiersCounterIncremented // Event containing the contract specifics and raw log
...
func (it *VerifiersCounterIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(VerifiersCounterIncremented)
...
func (it *VerifiersCounterIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *VerifiersCounterIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// VerifiersCounterIncremented represents a CounterIncremented event raised by the Verifiers contract.
type VerifiersCounterIncremented struct {
	NewCounter *big.Int
...
func (_Verifiers *VerifiersFilterer) FilterCounterIncremented(opts *bind.FilterOpts, offerer []common.Address) (*VerifiersCounterIncrementedIterator, error) {
	...
	logs, sub, err := _Verifiers.contract.FilterLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &VerifiersCounterIncrementedIterator{contract: _Verifiers.contract, event: "CounterIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event CounterIncremented(uint256 newCounter, address indexed offerer)
func (_Verifiers *VerifiersFilterer) WatchCounterIncremented(opts *bind.WatchOpts, sink chan<- *VerifiersCounterIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Verifiers.contract.WatchLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(VerifiersCounterIncremented)
				if err := _Verifiers.contract.UnpackLog(event, "CounterIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event CounterIncremented(uint256 newCounter, address indexed offerer)
func (_Verifiers *VerifiersFilterer) ParseCounterIncremented(log types.Log) (*VerifiersCounterIncremented, error) {
	event := new(VerifiersCounterIncremented)
	if err := _Verifiers.contract.UnpackLog(event, "CounterIncremented", log); err != nil {
		return nil, err
	}
