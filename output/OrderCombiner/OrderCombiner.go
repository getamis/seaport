...
var OrderCombinerMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// OrderCombinerCounterIncrementedIterator is returned from FilterCounterIncremented and is used to iterate over the raw logs and unpacked data for CounterIncremented events raised by the OrderCombiner contract.
type OrderCombinerCounterIncrementedIterator struct {
	Event *OrderCombinerCounterIncremented // Event containing the contract specifics and raw log
...
func (it *OrderCombinerCounterIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(OrderCombinerCounterIncremented)
...
func (it *OrderCombinerCounterIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *OrderCombinerCounterIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// OrderCombinerCounterIncremented represents a CounterIncremented event raised by the OrderCombiner contract.
type OrderCombinerCounterIncremented struct {
	NewCounter *big.Int
...
func (_OrderCombiner *OrderCombinerFilterer) FilterCounterIncremented(opts *bind.FilterOpts, offerer []common.Address) (*OrderCombinerCounterIncrementedIterator, error) {
	...
	logs, sub, err := _OrderCombiner.contract.FilterLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &OrderCombinerCounterIncrementedIterator{contract: _OrderCombiner.contract, event: "CounterIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event CounterIncremented(uint256 newCounter, address indexed offerer)
func (_OrderCombiner *OrderCombinerFilterer) WatchCounterIncremented(opts *bind.WatchOpts, sink chan<- *OrderCombinerCounterIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _OrderCombiner.contract.WatchLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(OrderCombinerCounterIncremented)
				if err := _OrderCombiner.contract.UnpackLog(event, "CounterIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event CounterIncremented(uint256 newCounter, address indexed offerer)
func (_OrderCombiner *OrderCombinerFilterer) ParseCounterIncremented(log types.Log) (*OrderCombinerCounterIncremented, error) {
	event := new(OrderCombinerCounterIncremented)
	if err := _OrderCombiner.contract.UnpackLog(event, "CounterIncremented", log); err != nil {
		return nil, err
	}
