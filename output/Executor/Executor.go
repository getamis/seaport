...
func DeployExecutor(auth *bind.TransactOpts, backend bind.ContractBackend, conduitController common.Address) (common.Address, *types.Transaction, *Executor, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ExecutorBin), backend, conduitController)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (it *ExecutorCounterIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExecutorCounterIncremented)
...
func (it *ExecutorCounterIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExecutorCounterIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Executor *ExecutorFilterer) FilterCounterIncremented(opts *bind.FilterOpts, offerer []common.Address) (*ExecutorCounterIncrementedIterator, error) {
	...
	logs, sub, err := _Executor.contract.FilterLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &ExecutorCounterIncrementedIterator{contract: _Executor.contract, event: "CounterIncremented", logs: logs, sub: sub}, nil
}
...
func (_Executor *ExecutorFilterer) WatchCounterIncremented(opts *bind.WatchOpts, sink chan<- *ExecutorCounterIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Executor.contract.WatchLogs(opts, "CounterIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ExecutorCounterIncremented)
				if err := _Executor.contract.UnpackLog(event, "CounterIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExecutorOrderCancelledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExecutorOrderCancelled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExecutorOrderCancelledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExecutorOrderCancelledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Executor *ExecutorFilterer) FilterOrderCancelled(opts *bind.FilterOpts, offerer []common.Address, zone []common.Address) (*ExecutorOrderCancelledIterator, error) {
	...
	logs, sub, err := _Executor.contract.FilterLogs(opts, "OrderCancelled", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return &ExecutorOrderCancelledIterator{contract: _Executor.contract, event: "OrderCancelled", logs: logs, sub: sub}, nil
}
...
func (_Executor *ExecutorFilterer) WatchOrderCancelled(opts *bind.WatchOpts, sink chan<- *ExecutorOrderCancelled, offerer []common.Address, zone []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Executor.contract.WatchLogs(opts, "OrderCancelled", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExecutorOrderCancelled)
				if err := _Executor.contract.UnpackLog(event, "OrderCancelled", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExecutorOrderFulfilledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExecutorOrderFulfilled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExecutorOrderFulfilledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExecutorOrderFulfilledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Executor *ExecutorFilterer) FilterOrderFulfilled(opts *bind.FilterOpts, offerer []common.Address, zone []common.Address) (*ExecutorOrderFulfilledIterator, error) {
	...
	logs, sub, err := _Executor.contract.FilterLogs(opts, "OrderFulfilled", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return &ExecutorOrderFulfilledIterator{contract: _Executor.contract, event: "OrderFulfilled", logs: logs, sub: sub}, nil
}
...
func (_Executor *ExecutorFilterer) WatchOrderFulfilled(opts *bind.WatchOpts, sink chan<- *ExecutorOrderFulfilled, offerer []common.Address, zone []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Executor.contract.WatchLogs(opts, "OrderFulfilled", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExecutorOrderFulfilled)
				if err := _Executor.contract.UnpackLog(event, "OrderFulfilled", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ExecutorOrderValidatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExecutorOrderValidated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ExecutorOrderValidatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExecutorOrderValidatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
func (_Executor *ExecutorFilterer) FilterOrderValidated(opts *bind.FilterOpts, offerer []common.Address, zone []common.Address) (*ExecutorOrderValidatedIterator, error) {
	...
	logs, sub, err := _Executor.contract.FilterLogs(opts, "OrderValidated", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return &ExecutorOrderValidatedIterator{contract: _Executor.contract, event: "OrderValidated", logs: logs, sub: sub}, nil
}
...
func (_Executor *ExecutorFilterer) WatchOrderValidated(opts *bind.WatchOpts, sink chan<- *ExecutorOrderValidated, offerer []common.Address, zone []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Executor.contract.WatchLogs(opts, "OrderValidated", offererRule, zoneRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ExecutorOrderValidated)
				if err := _Executor.contract.UnpackLog(event, "OrderValidated", log); err != nil {
					return err
				}
				event.Raw = log
