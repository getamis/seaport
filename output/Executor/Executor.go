...
var ExecutorMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// ExecutorNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the Executor contract.
type ExecutorNonceIncrementedIterator struct {
	Event *ExecutorNonceIncremented // Event containing the contract specifics and raw log
...
func (it *ExecutorNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ExecutorNonceIncremented)
...
func (it *ExecutorNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ExecutorNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ExecutorNonceIncremented represents a NonceIncremented event raised by the Executor contract.
type ExecutorNonceIncremented struct {
	NewNonce *big.Int
...
func (_Executor *ExecutorFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*ExecutorNonceIncrementedIterator, error) {
	...
	logs, sub, err := _Executor.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &ExecutorNonceIncrementedIterator{contract: _Executor.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_Executor *ExecutorFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *ExecutorNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Executor.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ExecutorNonceIncremented)
				if err := _Executor.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_Executor *ExecutorFilterer) ParseNonceIncremented(log types.Log) (*ExecutorNonceIncremented, error) {
	event := new(ExecutorNonceIncremented)
	if err := _Executor.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
