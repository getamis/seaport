...
var BasicOrderFulfillerMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// BasicOrderFulfillerNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the BasicOrderFulfiller contract.
type BasicOrderFulfillerNonceIncrementedIterator struct {
	Event *BasicOrderFulfillerNonceIncremented // Event containing the contract specifics and raw log
...
func (it *BasicOrderFulfillerNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BasicOrderFulfillerNonceIncremented)
...
func (it *BasicOrderFulfillerNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BasicOrderFulfillerNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BasicOrderFulfillerNonceIncremented represents a NonceIncremented event raised by the BasicOrderFulfiller contract.
type BasicOrderFulfillerNonceIncremented struct {
	NewNonce *big.Int
...
func (_BasicOrderFulfiller *BasicOrderFulfillerFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*BasicOrderFulfillerNonceIncrementedIterator, error) {
	...
	logs, sub, err := _BasicOrderFulfiller.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &BasicOrderFulfillerNonceIncrementedIterator{contract: _BasicOrderFulfiller.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_BasicOrderFulfiller *BasicOrderFulfillerFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *BasicOrderFulfillerNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _BasicOrderFulfiller.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BasicOrderFulfillerNonceIncremented)
				if err := _BasicOrderFulfiller.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_BasicOrderFulfiller *BasicOrderFulfillerFilterer) ParseNonceIncremented(log types.Log) (*BasicOrderFulfillerNonceIncremented, error) {
	event := new(BasicOrderFulfillerNonceIncremented)
	if err := _BasicOrderFulfiller.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
