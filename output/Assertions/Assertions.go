...
var AssertionsMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
// AssertionsNonceIncrementedIterator is returned from FilterNonceIncremented and is used to iterate over the raw logs and unpacked data for NonceIncremented events raised by the Assertions contract.
type AssertionsNonceIncrementedIterator struct {
	Event *AssertionsNonceIncremented // Event containing the contract specifics and raw log
...
func (it *AssertionsNonceIncrementedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AssertionsNonceIncremented)
...
func (it *AssertionsNonceIncrementedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AssertionsNonceIncrementedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AssertionsNonceIncremented represents a NonceIncremented event raised by the Assertions contract.
type AssertionsNonceIncremented struct {
	NewNonce *big.Int
...
func (_Assertions *AssertionsFilterer) FilterNonceIncremented(opts *bind.FilterOpts, offerer []common.Address) (*AssertionsNonceIncrementedIterator, error) {
	...
	logs, sub, err := _Assertions.contract.FilterLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return &AssertionsNonceIncrementedIterator{contract: _Assertions.contract, event: "NonceIncremented", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_Assertions *AssertionsFilterer) WatchNonceIncremented(opts *bind.WatchOpts, sink chan<- *AssertionsNonceIncremented, offerer []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Assertions.contract.WatchLogs(opts, "NonceIncremented", offererRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AssertionsNonceIncremented)
				if err := _Assertions.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceIncremented(uint256 newNonce, address indexed offerer)
func (_Assertions *AssertionsFilterer) ParseNonceIncremented(log types.Log) (*AssertionsNonceIncremented, error) {
	event := new(AssertionsNonceIncremented)
	if err := _Assertions.contract.UnpackLog(event, "NonceIncremented", log); err != nil {
		return nil, err
	}
