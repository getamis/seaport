...
func (_ConsiderationInterface *ConsiderationInterfaceCaller) GetNonce(opts *bind.CallOpts, offerer common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ConsiderationInterface.contract.Call(opts, &out, "getNonce", offerer)
...
//
// Solidity: function getNonce(address offerer) view returns(uint256 nonce)
func (_ConsiderationInterface *ConsiderationInterfaceSession) GetNonce(offerer common.Address) (*big.Int, error) {
	return _ConsiderationInterface.Contract.GetNonce(&_ConsiderationInterface.CallOpts, offerer)
}

// GetNonce is a free data retrieval call binding the contract method 0x2d0335ab.
//
// Solidity: function getNonce(address offerer) view returns(uint256 nonce)
func (_ConsiderationInterface *ConsiderationInterfaceCallerSession) GetNonce(offerer common.Address) (*big.Int, error) {
	return _ConsiderationInterface.Contract.GetNonce(&_ConsiderationInterface.CallOpts, offerer)
}
...
func (_ConsiderationInterface *ConsiderationInterfaceTransactor) FulfillAdvancedOrder(opts *bind.TransactOpts, advancedOrder AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillerConduitKey [32]byte) (*types.Transaction, error) {
	return _ConsiderationInterface.contract.Transact(opts, "fulfillAdvancedOrder", advancedOrder, criteriaResolvers, fulfillerConduitKey)
}

// FulfillAdvancedOrder is a paid mutator transaction binding the contract method 0xdf7b0dac.
//
// Solidity: function fulfillAdvancedOrder(((address,address,(uint8,address,uint256,uint256,uint256)[],(uint8,address,uint256,uint256,uint256,address)[],uint8,uint256,uint256,bytes32,uint256,bytes32,uint256),uint120,uint120,bytes,bytes) advancedOrder, (uint256,uint8,uint256,uint256,bytes32[])[] criteriaResolvers, bytes32 fulfillerConduitKey) payable returns(bool fulfilled)
func (_ConsiderationInterface *ConsiderationInterfaceSession) FulfillAdvancedOrder(advancedOrder AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillerConduitKey [32]byte) (*types.Transaction, error) {
	return _ConsiderationInterface.Contract.FulfillAdvancedOrder(&_ConsiderationInterface.TransactOpts, advancedOrder, criteriaResolvers, fulfillerConduitKey)
}

// FulfillAdvancedOrder is a paid mutator transaction binding the contract method 0xdf7b0dac.
//
// Solidity: function fulfillAdvancedOrder(((address,address,(uint8,address,uint256,uint256,uint256)[],(uint8,address,uint256,uint256,uint256,address)[],uint8,uint256,uint256,bytes32,uint256,bytes32,uint256),uint120,uint120,bytes,bytes) advancedOrder, (uint256,uint8,uint256,uint256,bytes32[])[] criteriaResolvers, bytes32 fulfillerConduitKey) payable returns(bool fulfilled)
func (_ConsiderationInterface *ConsiderationInterfaceTransactorSession) FulfillAdvancedOrder(advancedOrder AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillerConduitKey [32]byte) (*types.Transaction, error) {
	return _ConsiderationInterface.Contract.FulfillAdvancedOrder(&_ConsiderationInterface.TransactOpts, advancedOrder, criteriaResolvers, fulfillerConduitKey)
}
...
func (_ConsiderationInterface *ConsiderationInterfaceTransactor) FulfillAvailableAdvancedOrders(opts *bind.TransactOpts, advancedOrders []AdvancedOrder, criteriaResolvers []CriteriaResolver, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _ConsiderationInterface.contract.Transact(opts, "fulfillAvailableAdvancedOrders", advancedOrders, criteriaResolvers, offerFulfillments, considerationFulfillments, fulfillerConduitKey, maximumFulfilled)
}
...
func (_ConsiderationInterface *ConsiderationInterfaceSession) FulfillAvailableAdvancedOrders(advancedOrders []AdvancedOrder, criteriaResolvers []CriteriaResolver, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _ConsiderationInterface.Contract.FulfillAvailableAdvancedOrders(&_ConsiderationInterface.TransactOpts, advancedOrders, criteriaResolvers, offerFulfillments, considerationFulfillments, fulfillerConduitKey, maximumFulfilled)
}
...
func (_ConsiderationInterface *ConsiderationInterfaceTransactor) IncrementNonce(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ConsiderationInterface.contract.Transact(opts, "incrementNonce")
}

// IncrementNonce is a paid mutator transaction binding the contract method 0x627cdcb9.
//
// Solidity: function incrementNonce() returns(uint256 newNonce)
func (_ConsiderationInterface *ConsiderationInterfaceSession) IncrementNonce() (*types.Transaction, error) {
	return _ConsiderationInterface.Contract.IncrementNonce(&_ConsiderationInterface.TransactOpts)
}

// IncrementNonce is a paid mutator transaction binding the contract method 0x627cdcb9.
//
// Solidity: function incrementNonce() returns(uint256 newNonce)
func (_ConsiderationInterface *ConsiderationInterfaceTransactorSession) IncrementNonce() (*types.Transaction, error) {
	return _ConsiderationInterface.Contract.IncrementNonce(&_ConsiderationInterface.TransactOpts)
}
